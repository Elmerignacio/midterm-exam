...
<div>
  ...
  <p class="para1">Qualifications: <br>
    Currently enrolled in college or university, any course is acceptable. Familiarity with ordering supplies, managing inventory, and handling equipment. Capable of accurately managing stock records, receiving and stocking goods, and completing basic administrative tasks.
  </p>
  <p class="para2">Salary range:<spam class="pra2">5,000</spam></p>
  <div class="job">

  <i class="fa-solid fa-hand-holding-heart"> 
    <spam class="p1">WAREHOUSE ASSISTANCE</spam>
...
<p class="ps2">Ends at: December 20, 2024</p>
<p class="ps3">Number of Position: 10</p>
</div>
