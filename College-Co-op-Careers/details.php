...
<div>
  ...
  College co-op programs offer students practical work experience while studying. Requirements include enrollment in a relevant field, maintaining a GPA, and possibly needing work authorization. Strong communication and professionalism are crucial. Students apply similarly to regular jobs.
  </p>
  <p class="para2">Salary range:<spam class="pra2">5,000</spam></p>
  <div class="job">

  <i class="fa-solid fa-hand-holding-heart"> 
    <spam class="p1">Marketing assistant</spam>
