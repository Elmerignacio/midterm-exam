...
<div>
  ...
  Study break jobs are part-time opportunities designed for students, requiring basic skills like communication and time management. They offer valuable experience while accommodating academic schedules, promoting personal and professional development.
  </p>
  <p class="para2">Salary range:<spam class="pra2">5,000</spam></p>
  <div class="job">

  <i class="fa-solid fa-hand-holding-heart"> 
    <spam class="p1">Student Support Assistant</spam>
