...
<div>
  ...
  EduFlex Employment Agency matches students with part-time jobs that fit their schedules and interests, emphasizing skill development and supportive work environments for balanced academic and professional growth.
  </p>
  <p class="para2">Salary range:<spam class="pra2">5,000</spam></p>
  <div class="job">

  <i class="fa-solid fa-hand-holding-heart"> 
    <spam class="p1">Event staff</spam>
...
<p class="ps2">Ends at: May 8, 2024</p>
<p class="ps3">Number of Position: 15</p>
</div>
