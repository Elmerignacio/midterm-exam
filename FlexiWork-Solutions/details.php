...
<div>
    <button class="btn1"><i class="fa-solid fa-note-sticky"></i><a href="#"> Details</a></button>
  ...
  FlexiWork Solutions streamlines part-time job hunting for students with flexible schedules, offering tailored listings and a user-friendly platform. Their qualification process ensures seamless connections with reputable employers, enabling students to balance work and academics effectively.
  </p>
  <p class="para2">Salary range:<spam class="pra2">5,000</spam></p>
  <div class="job">

  <i class="fa-solid fa-hand-holding-heart"> 
    <spam class="p1">Student Flexi-Job Coordinator</spam>
...
<p class="ps2">Ends at: May 4, 2024</p>
<p class="ps3">Number of Position: 5</p>
</div>
