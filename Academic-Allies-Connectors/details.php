...
<div>
  ...
  Academic Allies Connectors provides a platform for students to connect with part-time job opportunities. With a focus on academic success, their qualified team ensures job listings match student schedules and preferences. 

  </p>
  <p class="para2">Salary range:<spam class="pra2">4,000</spam></p>
  <div class="job">

  <i class="fa-solid fa-hand-holding-heart"> 
    <spam class="p1">Student Job Coordinator</spam>
